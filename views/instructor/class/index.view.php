                                ...
                                <tbody>
                                    <?php foreach ($courses  as $course) : ?>
                                        <tr>
                                            ...
                                            <th>
                                                 <a class="btn btn-success btn-sm" href="/students/create">Edit</a>
                                                 <a class="btn btn-primary btn-sm" href="/students/create">View</a>
                                                 <a class="btn btn-danger btn-sm" href="/students/create">Delete</a>
                                            </th>
